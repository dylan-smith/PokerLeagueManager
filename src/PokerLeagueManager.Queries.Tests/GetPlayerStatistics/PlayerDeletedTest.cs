...
namespace PokerLeagueManager.Queries.Tests.GetPlayerStatistics
{
    ...
    public class PlayerDeletedTest : BaseQueryTest
    {
        ...
        [TestMethod]
        public void GetPlayerStatistics_PlayerDeleted()
        {
        ...
        {
            yield return new GetPlayerStatisticsDto() { DtoId = AnyGuid(), PlayerName = _player2, GamesPlayed = 1, Winnings = 0, PayIn = 20, Profit = -20, ProfitPerGame = -20 };
            yield return new GetPlayerStatisticsDto() { DtoId = AnyGuid(), PlayerName = _player3, GamesPlayed = 1, Winnings = 60, PayIn = 40, Profit = 20, ProfitPerGame = 20 };
        }
    }
}
