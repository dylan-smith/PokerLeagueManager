...
{
    [TestClass]
    public class PlayerRenamedMergedTest : BaseQueryTest
    {
        ...
        private string _player5 = "Christopher";
        ...
        public override IEnumerable<IDataTransferObject> ExpectedDtos()
        {
            ...
            yield return new GetPlayerStatisticsDto() { DtoId = AnyGuid(), PlayerName = _player3, GamesPlayed = 3, Winnings = 60, PayIn = 80, Profit = -20, ProfitPerGame = -20.0 / 3.0 };
