...
namespace PokerLeagueManager.Queries.Tests
{
    ...
    public class PlayerRenamedTest : BaseQueryTest
    {
        ...
        private string _newPlayerName = "Bob Sagat";
        ...
        public override IEnumerable<IEvent> Given()
        {
            ...
            yield return new PlayerRenamedEvent() { AggregateId = _gameId1, OldPlayerName = _player2_1, NewPlayerName = _newPlayerName };
            yield return new PlayerRenamedEvent() { AggregateId = _gameId2, OldPlayerName = _player1_2, NewPlayerName = _newPlayerName };
        }
        ...
        public override IEnumerable<IDataTransferObject> ExpectedDtos()
        {
            ...
            yield return new GetGamesListDto() { DtoId = AnyGuid(), GameId = _gameId2, GameDate = _gameDate2, Winner = _newPlayerName, Winnings = _winnings1_2 };
        }
    }
}
