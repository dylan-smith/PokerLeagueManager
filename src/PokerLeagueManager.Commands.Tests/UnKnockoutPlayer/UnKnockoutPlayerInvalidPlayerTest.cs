...
{
    [TestClass]
    public class UnKnockoutPlayerInvalidPlayerTest : BaseCommandTest
    {
        ...
        [TestMethod]
        public void UnKnockoutPlayerInvalidPlayer()
        {
            RunTest(new UnKnockoutPlayerCommand() { GameId = _gameId, PlayerId = Guid.NewGuid() });
        }
