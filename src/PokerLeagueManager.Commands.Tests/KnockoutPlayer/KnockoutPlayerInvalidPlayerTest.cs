...
{
    [TestClass]
    public class KnockoutPlayerInvalidPlayerTest : BaseCommandTest
    {
        ...
        [TestMethod]
        public void KnockoutPlayerInvalidPlayer()
        {
            RunTest(new KnockoutPlayerCommand() { GameId = _gameId, PlayerId = Guid.NewGuid() });
        }
