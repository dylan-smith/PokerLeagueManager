...
{
    [TestClass]
    public class KnockoutPlayerAlreadyKnockedOutTest : BaseCommandTest
    {
        ...
        [TestMethod]
        public void KnockoutPlayerAlreadyKnockedOut()
        {
        ...
        {
            return new PlayerAlreadyKnockedOutException(_gameId, _playerId);
        }
    }
}
