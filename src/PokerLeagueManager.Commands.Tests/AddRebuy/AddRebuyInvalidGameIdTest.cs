...
{
    [TestClass]
    public class AddRebuyInvalidGameIdTest : BaseCommandTest
    {
        ...
        [TestMethod]
        public void AddRebuyInvalidGameId()
        {
            RunTest(new AddRebuyCommand() { GameId = Guid.NewGuid(), PlayerId = _playerId });
        }
