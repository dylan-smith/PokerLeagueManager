...
namespace PokerLeagueManager.Commands.Tests.RemoveRebuy
{
    ...
    public class RemoveRebuyTest : BaseCommandTest
    {
        ...
        public override IEnumerable<IEvent> Given()
        {
            ...
            yield return new RebuyAddedEvent() { GameId = _gameId, PlayerId = _playerId, RebuyAmount = 10 };
        }
        ...
        {
            yield return new RebuyRemovedEvent() { GameId = _gameId, PlayerId = _playerId, RebuyAmount = 10 };
