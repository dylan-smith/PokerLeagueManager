...
{
    [TestClass]
    public class ThreeGamesTwoAffectedTest : BaseCommandTest
    {
        ...
        [TestMethod]
        public void RenamePlayer_ThreeGamesTwoAffected()
        {
        ...
        {
            yield return new PlayerRenamedEvent() { AggregateId = _gameId1, OldPlayerName = _player1, NewPlayerName = _newPlayerName };
