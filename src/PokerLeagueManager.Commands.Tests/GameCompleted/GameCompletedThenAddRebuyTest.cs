...
{
    [TestClass]
    public class GameCompletedThenAddRebuyTest : BaseCommandTest
    {
        ...
        [TestMethod]
        public void GameCompletedThenAddRebuy()
        {
            RunTest(new AddRebuyCommand() { GameId = _gameId, PlayerId = _playerId2 });
        }
