...
PokerLeagueManager.Utilities.CreateEventSubscriber\bin\Debug\PokerLeagueManager.Utilities.CreateEventSubscriber.exe localhost PokerLeagueManager.DB.EventStore http://localhost:1766/EventService.svc
