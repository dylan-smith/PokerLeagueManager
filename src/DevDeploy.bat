"C:\NuGet\Nuget.exe" Restore "%~dp0\PokerLeagueManager.sln"
"C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\Common7\IDE\devenv.com" "PokerLeagueManager.sln" /Build Debug
